...
/**
 * Send an email as html.
 *
 * @uses \Omeka\Stdlib\Mailer
 */
class MailerHtml extends AbstractPlugin
{
    /**
     * @var MailerService
     */
     ...
     * @param string $body
     * @param string $name Name of the recipient when it is a string
     * @return bool
     */
    public function __invoke($recipients, $subject, $body, $name = null): bool
    {
