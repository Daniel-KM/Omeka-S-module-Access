 ...
 */
class AccessReserved extends \AccessResource\Entity\AccessReserved implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccessReserved $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setStartDate(\DateTime $startDate = NULL): \AccessResource\Entity\AccessReserved
    {
     ...
     * {@inheritDoc}
     */
    public function setEndDate(\DateTime $endDate = NULL): \AccessResource\Entity\AccessReserved
    {
